...
const ModularAnimatedSpriteInspectorPlugin = preload("res://addons/AsepriteWizard/interface/docks/modular_animated_sprite/inspector_plugin.gd")
...
var modular_animated_sprite_inspector_plugin: EditorInspectorPlugin
...
func _enter_tree():
	...
	_setup_importer()
	_setup_exporter()
	_setup_modular_animated_sprite_inspector_plugin()
...
func _setup_modular_animated_sprite_inspector_plugin():
	modular_animated_sprite_inspector_plugin = ModularAnimatedSpriteInspectorPlugin.new()
	add_inspector_plugin(modular_animated_sprite_inspector_plugin)
...
func _remove_inspector_plugins():
	...
	remove_inspector_plugin(modular_animated_sprite_inspector_plugin)
